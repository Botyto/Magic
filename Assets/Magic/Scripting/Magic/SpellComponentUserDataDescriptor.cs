...
public class SpellComponentUserDataDescriptor : DispatchingUserDataDescriptor, IOptimizableDescriptor
{
    /// <summary>
    ...
    public SpellComponentUserDataDescriptor(Type type, InteropAccessMode accessMode, string friendlyName = null)
